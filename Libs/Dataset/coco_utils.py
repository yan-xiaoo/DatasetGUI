...
# Note: This file is copied and modified from pycocotools.coco
# This is because the module `pycocotools` depend on too many large packages
# that this program does not use. It also includes many useless functions for
# this program. For this reason, the module is simplified and built-in inside
# the program itself.
